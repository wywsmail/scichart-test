...
export const token = ref(
	"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ind5d3NtYWlsIiwic3ViIjoiYzMyYTlkOGYtYzBmZS00ZTIzLWJlYjktNGUwZDlkYjI0MzY4IiwiaWF0IjoxNjI4NzMxNzQyLCJleHAiOjE2Mjg4MTgxNDJ9.UwyjNxc2J_FQLAm3kemkb0uD8jO_yqg7QmG5apWQq9A"
);
export const isLogin = ref(
	JSON.parse(
